...
require "davidmorton0_palindrome/version"

Gem::Specification.new do |spec|
  spec.name          = "davidmorton0"
  spec.version       = Davidmorton0Palindrome::VERSION
  spec.authors       = ["Michael Hartl"]
  spec.email         = ["michael@michaelhartl.com"]

  spec.summary       = %q{Palindrome detector}
  spec.description   = %q{Learn Enough Ruby palindrome detector}
  spec.homepage      = "https://github.com/davidmorton0/davidmorton0_palindrome"
  spec.license       = "MIT"
